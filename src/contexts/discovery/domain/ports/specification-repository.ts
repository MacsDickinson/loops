...
export interface ISpecificationRepository {
  ...
  update(id: string, data: Partial<Pick<Specification, 'title' | 'description' | 'status' | 'requirements' | 'acceptanceTests' | 'linkedGithubPr' | 'linkedLinearIssue'>>): Promise<Specification>
